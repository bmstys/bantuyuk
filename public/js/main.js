(function ($) {
    ...
    function changeImage() {   
        ...
        var currentBg = $('.home-area').css('background-image');
        console.log(currentBg);
        console.log(BackgroundImg[0]);
        if (currentBg.indexOf(BackgroundImg[0]) !== -1) {
            $('.home-area').css('background-image', 'url("' + BackgroundImg[1] + '")');
        } else {
           $('.home-area').css('background-image', 'url("' + BackgroundImg[0] + '")');
        }
    }
