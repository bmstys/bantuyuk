...
<div class="container-fluid" style="padding-top: 110px;padding-bottom:40px;background-color: #F5F6FF;z-index: 0;min-height: 720px;">
    <div class="container">
        ...
        <div class="alert alert-success" role="alert">
            <div class="text-left">
                <b style="padding-left: 15px;">Barang-barang yang dibutuhkan di bencana {{ $donasi->bencana->nama }}</b>
                <br>
                ...
                <p style="color: red;padding-left: 15px;margin-bottom: 0px;font-size: 14px;line-height: 18px;">Isikan jumlah barang yang ingin Anda donasikan<br>Kosongkan jumlah barang apabila Anda tidak ingin mendonasikan barang tersebut</p>
            </div>
        </div>

        <form action="{{ url('/scpk/donasi/konfirmasi') }}" method="POST">
